...
private:
	Keyboard::Key m_key_val = Keyboard::UNDEFINED_KEY; // Key value.
	EventKeyboardAction m_keyboard_action = UNDEFINED_KEYBOARD_ACTION; // Key action.
...
Keyboard::Key SFMLKeyCodeToDFKeyCode(sf::Keyboard::Key sfml_key_event);
